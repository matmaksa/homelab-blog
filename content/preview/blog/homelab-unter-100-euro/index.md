...
Dieser Artikel zeigt, was du wirklich brauchst, worauf du sparen kannst und wo sich eine geringere Anfangsinvestition trotzdem lohnt.
...
**[Thin Clients]({{< relref "fujitsu-futro-s7010-homelab-einstieg" >}})** wie der Fujitsu Futro **S740** oder **S7010**, HP t730 oder Dell Wyse 5070 lassen sich gebraucht je nach Zustand, Ausstattung und Händler für **20–50 Euro** finden (Stand Juli 2026). Sie sind leise, klein und verbrauchen im Betrieb meist unter 20 Watt. 4 GB RAM sind das absolute Minimum für erste Experimente – wer mehr vorhat oder mehrere Dienste betreiben möchte, sollte zur Variante mit 8 GB RAM greifen.
...
**RAM-Hinweis**: Beim RAM immer das konkrete Angebot und Datenblatt prüfen. Viele S740/S7010-Angebote kommen mit 4–8 GB RAM; 8 GB sind die sinnvolle Empfehlung für einen soliden Start. 16 GB können je nach Modell, BIOS und Modul möglich sein, sollten aber vor dem Kauf geprüft werden.

**[Mini-PCs]({{< relref "mini-pc-homelab-vergleich" >}})** der Serien Lenovo ThinkCentre M710q / M720q, HP ProDesk 400 G5 oder Dell OptiPlex 3070 Micro sind leistungsfähiger, liegen aber meist eher bei **100–130 Euro oder höher** (Stand Juli 2026). Sie sind als Upgrade-Option interessant, passen nicht immer in ein reines 100-Euro-Budget. Wer unter 100 Euro bleiben will, ist mit einem Thin Client realistischer unterwegs.
...
- Mehr **RAM** ist wichtiger als eine große SSD. 8 GB sind die sinnvolle Empfehlung für einen soliden Start, 16 GB der Komfortbereich für mehrere Dienste gleichzeitig.
...
Ein Homelab unter 100 € braucht kein Wifi 7 und keinen 10-Gbit-Switch. Ein einfacher **TP-Link oder Netgear Switch mit 5 Ports** (neu ca. 15–20 Euro, gebraucht oft günstiger – Stand Juli 2026) ist völlig ausreichend.

Einzige Empfehlung: Verwende **Cat‑6 Patchkabel** – die sind nicht teuer, ersparen aber später Ärger mit der Fehlersuche.

## Stromverbrauch – der oft unterschätzte Posten

Ein Thin Client mit typisch 15–20 Watt (je nach Ausstattung) kostet bei 24/7-Betrieb etwa **30–45 Euro pro Jahr** (bei 30 Cent/kWh, Stand Juli 2026). Im Idle ist der Verbrauch oft noch niedriger. Ein Desktop-Rechner mit 80–100 Watt käme dagegen schnell auf 200 Euro pro Jahr – das sprengt das Budget nicht nur einmal, sondern dauerhaft.

## Was du nicht brauchst

Manche Dinge klingen wichtig, sind aber für den Start überflüssig:

- **USV** – sinnvoll als spätere Ergänzung, aber kein Pflichtkauf zum Einstieg.
...
- **Teure Domain- oder Hosting-Setups** brauchst du am Anfang nicht. Für die Lernphase reicht entweder lokaler Zugriff oder Tailscale/Headscale. DynDNS mit Let's Encrypt ist ein fortgeschrittenes Thema, das sich lohnt, wenn du bewusst mit HTTPS und externem Zugriff üben möchtest – wichtig dabei: keine Dienste unüberlegt offen ins Internet stellen.
...
*Alle Preisangaben: Stand Juli 2026.*
