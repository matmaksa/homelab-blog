...
Transparenz zum Labortest: Der Test wurde in einer isolierten Umgebung auf einem Proxmox-Host durchgeführt. Die hier gezeigten Aufnahmen stammen aus einem LXC-Container der Community-Script-Route; dort wurden die Dienste und die Konfiguration read-only geprüft, und die Weboberfläche enthielt keine Dokumente. Der Nachweis für Import und OCR mit einem synthetischen PDF stammt aus einem gesonderten Labortest derselben Evidenzkette. Eine authentifizierte Volltextsuche und ein Backup-/Restore-Test wurden nicht durchgeführt.
...
> **Hinweis zur WebUI-Evidenz**: Authentifizierte Aufnahmen der späteren Instanz zeigen die Weboberfläche ohne Dokumente. Sie belegen den damaligen Login- und UI-Zustand, aber keinen Upload- oder OCR-Ablauf. Die folgenden Schritte beschreiben den dokumentierten Funktionsweg und sind vor dem Produktivbetrieb mit eigenen synthetischen Dokumenten zu verifizieren.
