...
tags = ["homelab", "einsteiger", "starter", "checkliste", "vorlage", "pdf", "download", "lead-magnet"]
categories = ["Homelab", "Tools"]
...
next_action = "setup_mailerlite_then_publish"

[cover]
  image = "featured.jpg"
  alt = "MATMAKSA Homelab Starter-Pack – 5 Vorlagen als PDF"
  relative = true
+++

> [!IMPORTANT] 
> **Preview – noch nicht veröffentlicht.** Dies ist ein Entwurf mit Platzhalter für das MailerLite-Formular.
> - Typ: `article_draft`
> - Publish-Eligible: `false`
> - Nächster Schritt: MailerLite einrichten, Embed-Code einsetzen, dann visuelle Freigabe durch Matmaksa

---

Du hast einen gebrauchten Mini-PC bestellt, Proxmox installiert – und jetzt? Welcher Dienst kommt zuerst? Welche IP kriegt was? Wie oft muss ich Backups testen?

Für den Einstieg fehlt oft nicht das Wissen, sondern eine **klare Struktur**. Deshalb habe ich das **MATMAKSA Homelab Starter-Pack** zusammengestellt: fünf Seiten Vorlagen zum Ausfüllen, Abhaken und Weglegen – für den Schreibtisch neben dem Server.
...
## 📥 Starter-Pack herunterladen

<!-- HIER KOMMT DAS MAILERLITE-EMBED-FORMULAR REIN -->
<!-- Nach MailerLite-Einrichtung: Embed-Code aus MailerLite > Forms > Lead-Magnet-Formular > Embed hier einsetzen -->
<!-- Das PDF liegt unter /downloads/MATMAKSA-Homelab-Starter-Pack.pdf -->

<div style="background: #eaf1f9; border: 2px dashed #2c5f8a; border-radius: 8px; padding: 24px; text-align: center; margin: 20px 0;">
  <p style="font-size: 16px; font-weight: 700; margin-bottom: 8px;">📥 MATMAKSA Homelab Starter-Pack</p>
...
- [ ] Du weißt, welche Hardware für dein erstes Homelab nötig ist
- [ ] Du hast einen Netzwerkplan mit IPs und VLANs
- [ ] Du kannst Proxmox Schritt für Schritt installieren
- [ ] Du hast einen Backup- und Testplan für deine Daten
- [ ] Du kennst die ersten 10 Dienste und weißt, wo du anfangen solltest
