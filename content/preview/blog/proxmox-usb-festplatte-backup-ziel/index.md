...
recommended_action = "selected_cover_visual_review"
...
> **Cover-Preview – nicht öffentlich freigegeben:** Diese Vorschau zeigt den bestehenden Artikel mit dem von SunnyStar ausgewählten neuen Cover (Vorschlag 1). Der öffentliche Artikel und sein bisheriges Cover bleiben unverändert, bis ein separates Veröffentlichungs-GO vorliegt.
>
> **Status:** `REVIEW_REQUIRED` · **Prüfung:** Motiv und Zuschnitt ausgewählt; öffentliche Übernahme noch nicht freigegeben.
...
{{< figure src="pve04-usb-storage-live-status.svg" alt="Aktueller bereinigter Leseauszug aus PVE04: USB-HDD als ext4 und Proxmox-Storage Backup aktiv." caption="Aktuelle READ-Prüfung vom 03.09.2026: Die USB-HDD ist als ext4-Mount sichtbar und das Proxmox-Storage `Backup` aktiv. Dieser Auszug dokumentiert keinen neuen Backup- oder Restore-Lauf." >}}
